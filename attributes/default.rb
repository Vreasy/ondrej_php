...
default['php']['packages'] = %w(php5.6-bcmath php5.6-json php5.6-memcached php5.6-mbstring php5.6-intl php5.6-xml php5.6-xml php5.6-curl php5.6-cli php5.6 php5.6-fpm php5.6-mysql php-pear)
